...
export declare function parseAuthPositiveInt(raw: string | number | undefined, label: string): number | undefined;
...
export declare function configureAuthCommandSurface(program: Command): {
    auth: Command;
    status: Command;
    refresh: Command;
};
