...
export declare function buildUpgradeCommand(spec?: string): UpgradeCommand;
/**
 ...
 */
export declare function getRuntimeUpdateNotice(): string | undefined;
/** Run the global install, streaming package-manager output. Throws on failure. */
export declare function upgradePackage(): UpgradeCommand;
