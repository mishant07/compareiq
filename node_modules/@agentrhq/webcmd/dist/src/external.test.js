...
import { executeExternalCli, formatExternalCliLabel, installExternalCli, isBinaryInstalled, parseCommand } from './external.js';
...
describe('formatExternalCliLabel', () => {
    ...
    it('renders a human-readable brand alias for ambiguous executable names', () => {
        ...
        expect(formatExternalCliLabel({ name: 'lin', binary: 'lin', package: 'linear' })).toBe('lin(linear)');
    });
});
