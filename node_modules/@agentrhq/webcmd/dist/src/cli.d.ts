...
export declare function createProgram(BUILTIN_CLIS: string, USER_CLIS: string, pluginsDir?: string): Command;
export declare function loadAntigravityServe(pluginsDir?: string): Promise<{
    startServe(options: {
        port: number;
        timeout?: number;
    }): Promise<void>;
 ...
 */
export declare function isExternalRootCommand(program: Command, name: string | undefined): boolean;
export declare function runCli(BUILTIN_CLIS: string, USER_CLIS: string, program?: Command): Promise<void>;
