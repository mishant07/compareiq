import type { AdapterAnalysisCommand, AdapterAnalysisSourceReader } from './adapter-analysis.js';
...
export declare function auditAdapterConventions(commands: readonly AdapterAnalysisCommand[], options: {
    target?: string;
    site?: string;
