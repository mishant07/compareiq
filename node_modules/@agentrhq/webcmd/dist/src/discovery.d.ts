...
export declare function getUserWebcmdDir(homeDir?: string): string;
export declare function getUserClisDir(homeDir?: string): string;
export declare function getPluginsDir(homeDir?: string): string;
/** User runtime directory: ~/.webcmd */
export declare const USER_WEBCMD_DIR: string;
...
export declare function getAdapterLoadFailures(): ReadonlyArray<{
    site: string;
    file: string;
    error: string;
}>;
 ...
 */
export declare function discoverPlugins(pluginsDir?: string): Promise<void>;
export declare function missingPluginGuidance(site: string): string;
