...
describe('hosted root command surface', () => {
    ...
    it.each(profileForms.flatMap(profile => dispatchForms.map(dispatch => ({ profile, dispatch }))))('leaves a child-owned completion sentinel with $profile.name/$dispatch.name', ({ profile, dispatch }) => {
