...
export declare const HOSTED_SESSION_PROTOCOL_VERSION: 1;
...
export type HostedDoctorCheckId = 'api' | 'workspace' | 'compatibility' | 'profile' | 'browser-provider' | 'capacity';
...
export type HostedBrowserActionName = 'analyze' | 'back' | 'bind' | 'check' | 'click' | 'close-window' | 'console' | 'dblclick' | 'dialog-accept' | 'dialog-dismiss' | 'drag' | 'exec' | 'extract' | 'fill' | 'find' | 'focus' | 'fork' | 'frames' | 'get-attributes' | 'get-html' | 'get-text' | 'get-title' | 'get-url' | 'get-value' | 'hover' | 'init' | 'insert-text' | 'navigate' | 'network' | 'press-key' | 'run' | 'screenshot' | 'scroll' | 'select' | 'set-file-input' | 'snapshot' | 'tabs' | 'type' | 'uncheck' | 'verify' | 'wait';
