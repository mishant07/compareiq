...
export interface ExternalCliConfig {
    /** User-facing Webcmd subcommand and, by default, the executable name. */
    name: string;
    binary: string;
    /**
...
export declare function executeExternalCli(name: string, args: string[], preloaded?: ExternalCliConfig[]): number;
