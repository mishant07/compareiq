...
import { CliError, BrowserConnectError, adapterLoadError, CommandExecutionError, ConfigError, AuthRequiredError, TimeoutError, InterruptedError, ArgumentError, EmptyResultError, selectorError, SessionBusyError, attachTraceReceipt, toEnvelope, withAdapterRepairHelp, } from './errors.js';
...
describe('toEnvelope', () => {
    ...
    it('preserves hosted object details on the CLI error envelope', () => {
        ...
        const err = new HostedClientError('BROWSER_RUN_TIMEOUT', 'The browser program timed out.', 'Retry with a shorter program.', 75, { details });
        expect(toEnvelope(err)).toEqual({
            ok: false,
            error: {
