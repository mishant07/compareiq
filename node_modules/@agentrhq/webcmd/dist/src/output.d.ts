...
export declare function errorEnvelopeFormat(fmt?: unknown): 'json' | 'yaml';
export declare function requestedFormatFromArgv(argv: readonly string[]): string | undefined;
/**
 ...
 */
export declare function requestedMachineFormat(argv: readonly string[]): 'json' | 'yaml' | undefined;
