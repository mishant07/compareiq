...
export declare const ROOT_SESSION_FLAGS = "--session <session-id>";
export declare const ROOT_SESSION_DESCRIPTION = "Existing readable Session ID from `webcmd session create <name>`";
export declare const ROOT_SESSION_SELECTOR_POSITION = "root";
...
export declare function configureHostedWorkspaceOption(program: Command): Command;
...
export declare function rootCompletionSentinelIndex(argv: readonly string[]): number;
