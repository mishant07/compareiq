...
export class Page extends BasePage {
    ...
    adapterSite;
    _idleTimeout;
    constructor(session, idleTimeout, contextId, windowMode, surface = 'browser', siteSession, preferredContextId, freshPage, adapterSite) {
        super();
    ...
    _markUnsupportedNetworkCapture() {
        ...
        log.warn('Browser runtime does not support network capture; continuing without it. ' +
            'Explore output may miss API endpoints until the runtime is updated.');
    }
    ...
    async clickWithQuads(ref) {
        ...
        const cssSelector = `[data-webcmd-ref="${ref.replace(/"/g, '\\"')}"]`;
        // Scroll element into view first
        await this.evaluate(`
      (() => {
        const el = document.querySelector('[data-webcmd-ref="' + ${safeRef} + '"]');
