...
export declare class Page extends BasePage {
    ...
    private readonly adapterSite?;
    private readonly _idleTimeout;
    constructor(session: string | undefined, idleTimeout?: number, contextId?: string | undefined, windowMode?: "foreground" | "background" | undefined, surface?: 'browser' | 'adapter', siteSession?: "ephemeral" | "persistent" | undefined, preferredContextId?: string | undefined, freshPage?: boolean, adapterSite?: string | undefined);
    ...
    closeTab(target?: number | string, options?: {
        force?: boolean;
    }): Promise<void>;
