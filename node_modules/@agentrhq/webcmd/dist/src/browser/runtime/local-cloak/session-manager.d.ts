...
import { launchChromePersistentContext } from './chrome-launch.js';
import { exportCookiesToNativeChrome as defaultExportCookies, ensureNativeProfileDirectory as defaultEnsureNativeProfileDirectory } from '../../google-chrome.js';
...
export declare const CHROME_SYNC_EXPORT_DEBOUNCE_MS = 3000;
/**
...
export declare class CloakSessionManager {
    ...
    private readonly ensureNativeProfileDirectory;
    private readonly exportCookiesToNativeChrome;
    private readonly registerNativeChromeProfile;
    private readonly syncExportsInFlight;
    private readonly chromeSyncExportTimers;
    ...
    private scheduleChromeSyncExport;
    private cancelChromeSyncExport;
    private scheduleChromeExport;
    private exportProfileToChrome;
