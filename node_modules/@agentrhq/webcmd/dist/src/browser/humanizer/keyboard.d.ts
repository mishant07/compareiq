...
export declare function shouldAllowIntentionalMistype(target?: HumanTypeTarget): boolean;
/**
 ...
 */
export declare function humanType(page: Page, raw: RawKeyboard, text: string, cfg: HumanConfig, cdpSession?: CDPSession | null, target?: HumanTypeTarget, random?: () => number, signal?: AbortSignal): Promise<void>;
