...
export declare const DEFAULT_CONFIG: Readonly<HumanConfig>;
/**
 ...
 * without re-patching.
 */
export declare function mergeConfig(cfg: HumanConfig, overrides?: Partial<HumanConfig> | null): HumanConfig;
