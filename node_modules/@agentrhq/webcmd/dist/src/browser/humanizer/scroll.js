...
async function smoothWheel(raw, delta, cfg, signal) {
 ...
 */
export async function humanScrollIntoView(page, raw, getBox, cursorX, cursorY, cfg, signal) {
 ...
 */
export async function scrollToElement(page, raw, selector, cursorX, cursorY, cfg, timeout, signal) {
    return humanScrollIntoView(page, raw, () => getElementBox(page, selector, timeout), cursorX, cursorY, cfg, signal);
}
