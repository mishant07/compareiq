 ...
 */
export declare function humanScrollIntoView(page: Page, raw: RawMouse, getBox: () => Promise<ElementBounds | null>, cursorX: number, cursorY: number, cfg: HumanConfig, signal?: AbortSignal): Promise<{
    box: ElementBounds;
    cursorX: number;
    cursorY: number;
    didScroll: boolean;
 ...
 */
export declare function scrollToElement(page: Page, raw: RawMouse, selector: string, cursorX: number, cursorY: number, cfg: HumanConfig, timeout?: number, signal?: AbortSignal): Promise<{
    box: ElementBounds;
    cursorX: number;
    cursorY: number;
    didScroll: boolean;
