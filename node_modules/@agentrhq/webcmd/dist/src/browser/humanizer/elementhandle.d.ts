...
export declare function restorePatchedElementHandles(page: Page): void;
interface CursorState {
    x: number;
    y: number;
    initialized: boolean;
}
export declare function patchSingleElementHandle(el: ElementHandle, page: Page, cfg: HumanConfig, cursor: CursorState, raw: RawMouse, rawKb: RawKeyboard, originals: any, stealth: any, signal?: AbortSignal): void;
export declare function patchPageElementHandles(page: Page, cfg: HumanConfig, cursor: CursorState, raw: RawMouse, rawKb: RawKeyboard, originals: any, stealth: any, signal?: AbortSignal): void;
export declare function patchFrameElementHandles(frame: Frame, page: Page, cfg: HumanConfig, cursor: CursorState, raw: RawMouse, rawKb: RawKeyboard, originals: any, stealth: any, signal?: AbortSignal): void;
export {};
