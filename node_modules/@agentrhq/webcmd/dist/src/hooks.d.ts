...
export declare const WEBCMD_ROOT_COMMANDS: ReadonlySet<string>;
export declare function shouldRunStartupSideEffects(argv: readonly string[]): boolean;
export declare function shouldEnsureUserCliCompatShims(argv: readonly string[]): boolean;
export declare function shouldEmitStartupHook(argv: readonly string[]): boolean;
/**
