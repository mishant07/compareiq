 ...
 */
function matchesSearchQuery(plugin, query) {
...
function normalizeCatalog(value, filePath) {
    ...
    return {
        version: 1,
        sources: value.sources.map((source, index) => normalizeOfficialCatalogSource(normalizeCatalogSource(source, `${filePath} sources[${index}]`))),
    };
}
