 ...
 */
export declare function getDirtyFiles(dir: string, options?: {
    pathspec?: string;
    against?: string;
}): string[];
/**
...
export declare function looksLikePluginName(source: string): boolean;
/**
 ...
 */
export declare class InvalidPluginSourceError extends Error {
 ...
 */
export declare function updateAllPlugins(options?: {
    force?: boolean;
}): UpdateResult[];
 ...
 */
export declare function findOverridesNeedingReconcile(pluginNames?: string[]): OverrideReconcileNeed[];
/**
