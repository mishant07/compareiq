...
vi.mock('../output.js', async () => ({
    ...(await vi.importActual('../output.js')),
...
const plainResult = { status: 200, requestedUrl: 'https://example.com', finalUrl: 'https://example.com', contentType: 'text/plain', tier: 'plain', title: 'Example', extractionSource: 'raw', truncated: false, content: 'ok' };
function program() {
...
describe('web fetch command', () => {
    ...
    it('renders fetched documents as markdown but preserves structured JSON', async () => {
        ...
        const markdown = mockRenderOutput.mock.calls[0][1].markdown;
