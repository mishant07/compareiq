...
function useBrowserConfig(browser) {
...
describe('browser helpers', () => {
    ...
    it('honors WEBCMD_CDP_TARGET when multiple inspectable targets exist', () => {
        vi.stubEnv('WEBCMD_CDP_TARGET', 'codex');
        const target = cdpTest.selectCDPTarget([
            {
                type: 'app',
                title: 'Cursor',
...
describe('BrowserBridge state', () => {
    ...
    it('attempts stale daemon replacement even when runtime is connected', async () => {
        vi.spyOn(daemonTransport, 'getDaemonHealth').mockResolvedValue({
            state: 'ready',
            status: {
                ok: true,
