/**
 * Unified error types for webcmd.
 *
 ...
 * ## Exit codes
 *
 * webcmd follows Unix conventions (sysexits.h) for process exit codes:
 *
 *   0   Success
...
export declare class SessionBusyError extends CliError {
    constructor(holder: SessionLeaseHolder, platform?: string, pidAlive?: (pid: number) => boolean);
}
/** Next action when an adapter command looks stale. Named so JSON envelopes carry it, not only YAML comments. */
export declare function adapterRepairHelp(commandKey?: string): string;
export declare function withAdapterRepairHelp(envelope: ErrorEnvelope, cmdName?: string): ErrorEnvelope;
